<?php 
    ...
    $folders = scandir('pages/upload/'.sha1($f).'/');

	if(isset($_GET['folder']) && !empty($_GET['folder']) && in_array($_GET['folder'],$folders)){
		$folder = $_GET['folder'];
	}else{
		$folder = '';
	}
	...
	<section>
		...
		<div id="panel-div-stockage" style="min-height: 100vh; height: auto;">
			...
			<div id="stockage-panel-div-menu">
					...
					<button id="btn-access" style="margin-left: 2em; margin-top: 1em;"><a href="?p=files&token=<?php echo $_SESSION['token']; ?>" id="link-panel">Retour</a></button>

					<center><h2 style="margin-left: 2em; margin-top: -1.2em;">7 Go de Stockage</h2></center>
					
					<!-- <div id="OtherForm">

    					<a href="?p=add-folder&folder=<?php # echo $folder; ?>"><img src="./img/add-folder.png" alt="Folder" name="AddFolder" style="float: right; margin-right: 2em; margin-top: -2em;" width="24" height="24"></a>
    				...
    				<div id="OtherForm">
    					...
    					<img src="./img/delete-folder.png" alt="Folder" name="DeleteFolder" href="#folder_r" class="js-modal" style="float: right; margin-right: -2em; margin-top: -2.5em;" width="24" height="24">
    							...
    							if (file_exists("pages/upload/" . $_SESSION['name_crypted'] . "/" . $folder_d . "/")) {
    								...
    								if (!$_SESSION['token']) {
    							        ...
    							        if ($_SESSION['token'] == $token) {
    							            ...
    							            rmdir("pages/upload/" . $_SESSION['name_crypted'] . "/".$folder."/" . $folder_d . "/");
							    ...
							    if(isset($_FILES["files_a"]) && $_FILES["files_a"]["error"] == 0){
							        ...
							        if($filesize > $maxsize) die();
					                    ...
					                    /* On vérifie si le fichier existe déjà */
					                   	...
					                   	if(file_exists("pages/upload/" . $_SESSION['name_crypted'] . "/" . $_SESSION['folder'] . "/" . $_FILES["files_a"]["name"])){

                                        } else{

								            move_uploaded_file($_FILES["files_a"]["tmp_name"], "pages/upload/" . $_SESSION['name_crypted'] . "/" . $_SESSION['folder'] . "/" . $_FILES["files_a"]["name"] . ".txt");
					...
					<div class="modal-wrapper js-modal-stop">
						...
						<?php
							...
							if(isset($_POST['submit_r_f'])){
								...
								if (file_exists("pages/upload/" . $_SESSION['name_crypted'] . "/" . $_SESSION['folder'] . "/" . $files_d)) {
									...
									if (!$_SESSION['token']) {
    								    ...
    								    if ($_SESSION['token'] == $token) {
    								        ...
    								        unlink("pages/upload/" . $_SESSION['name_crypted'] . "/" . $_SESSION['folder'] . "/" . $files_d);
				...
				<?php
					...
					$dir_nom = "pages/upload/" . $_SESSION['name_crypted'] . "/" . $folder;
							...
							?>
								...
								<aside id="edit" class="modal" aria-hidden="true" role="dialog" aria-modal="false" style="display:none;">
									...
									<div class="modal-wrapper js-modal-stop">
										...
										<iframe src="pages/upload/<?php echo $_SESSION['name_crypted']."/".$_SESSION['folder']."/".$lien; ?>" style="width: 420px; height: auto; border: none;"></iframe>
									...
									<div class="modal-wrapper js-modal-stop">
										...
										<?php
											...
											if (isset($_POST['save'])) {
												...
												fwrite(fopen("pages/upload/".$_SESSION['name_crypted']."/".$_SESSION['folder']."/".$lien, "w"), $textarea);
										...
										<form method="post" id="formEdit">
											...
											<textarea id="textarea-modal" name="textarea"><?php echo fread(fopen("pages/upload/".$_SESSION['name_crypted']."/".$_SESSION['folder']."/".$lien, "r+"), filesize("pages/upload/".$_SESSION['name_crypted']."/".$_SESSION['folder']."/".$lien)); ?></textarea>
							...
							?>
								...
								<aside id="edit34" class="modal" aria-hidden="true" role="dialog" aria-modal="false" style="display:none;">
									...
									<div class="modal-wrapper js-modal-stop">
										...
										<iframe src="pages/upload/<?php echo $_SESSION['name_crypted']."/".$_SESSION['folder']."/".$lien; ?>" style="width: 500px"></iframe>
