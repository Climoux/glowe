...
<head>
	...
	<title>Glowe Inc. - Hébergeur, un hébergeur de fichiers simple et sécurisé</title>
...
<body onload="document.location = '#'">
	...
	<?php
		...
		$pages_visibility_main = scandir('pages/visibility/');

		if(isset($_GET['f']) && !empty($_GET['f']) && in_array($_GET['f'].'.php',$pages_visibility_main)){
			$f = $_GET['f'];
	...
	<?php 
	if ($p == "browse" || $p == "stockage-panel" || $p == "visibility" || $p == "files" || $p == "folder" || $p == "add-folder" || $p == "main" || $p == "main-folder") {
	?>
	...
	<section id="section-nav-panel_otherspages">
		...
		<div id="topnav_menu">
			...
			<div id="link-div-menu">
				...
				<a href="?p=browse" id="home-link">Parcourir</a>
			</div>
        ...
        <nav role="navigation" id="topnav_responsive_menu">
			...
			<li><a href="?p=browse" id="home-link">Parcourir</a></li>
