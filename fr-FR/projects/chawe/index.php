...
<body onload="document.location = \'#\'">
	...
	<section id="section-nav-panel">
		...
		<div id="topnav_menu">
			...
			<div id="link-div-menu">
				...
				<a href="?p=chat" id="home-link">Chat</a>
			</div>
			...
			<div id="btn-div-menu">
				...
				<?php
					...
					?>
						...
						<a href="https://glowe.fr/fr-FR/?p=profil"><button id="btn-profil"><?php echo $_SESSION['name']; ?></button></a>

						<a href="https://glowe.fr/fr-FR/?p=logout"><button id="btn-deco">Déconnexion</button></a>
					...
					?>
						...
						<a href="https://glowe.fr/fr-FR/?p=login"><button id="btn-signin">Connexion</button></a>

						<a href="https://glowe.fr/fr-FR/?p=signup"><button id="btn-registration">S'inscrire</button></a>
        ...
        <nav role="navigation" id="topnav_responsive_menu">
			...
			<li><a href="?p=chat" id="home-link">Chat</a></li>
			...
			<?php
				...
				if(isLogged() == 1) {
					...
					?>
						...
						<li><a href="https://glowe.fr/fr-FR/?p=logout"><button id="btn-deco">Déconnexion</button></a></li>

						<li><a href="https://glowe.fr/fr-FR/?p=profil"><button id="btn-profil"><?php echo $_SESSION['name']; ?></button></a></li>
					...
					?>
						...
						<li><a href="https://glowe.fr/fr-FR/?p=registration"><button id="btn-registration">S'inscrire</button></a></li>

						<li><a href="https://glowe.fr/fr-FR/?p=signin"><button id="btn-signin">Connexion</button></a></li>
		...
		<center>
			...
			<div id="div-footer-secu-text">
				<br>
					...
					<h4><a href="https://glowe.fr/fr-FR/?p=cgu" style="font-size:14px;">Conditions d’Utilisation</a></h4>
					<h4><a href="https://glowe.fr/fr-FR/?p=rules" style="font-size:14px;">Règlement</a></h4>
					<h4><a href="https://glowe.fr/fr-FR/?p=mod" class="js-modal" style="font-size:14px;">Modération</a></h4>
				<br>
			</div>
			...
			<div id="div-footer-glowe-text">
				<br>
					...
					<h4><a href="https://glowe.fr/fr-FR/?p=about&c=glowe" style="font-size:14px;">À Propos du Site</a></h4>
			...
			<div id="div-footer-recruts-text">
				<br>
					...
					<h4><a href="https://glowe.fr/fr-FR/?p=about&c=work" style="font-size:14px;">À Propos</a></h4>
					<h4><a href="https://glowe.fr/fr-FR/?p=recruitment" style="font-size:14px;">Recrutements</a></h4>
					<h4><a href="https://glowe.fr/fr-FR/?p=actus" class="js-modal" style="font-size:14px;">Actualités</a></h4>
				<br>
			</div>
	...
	<script src="https://glowe.fr/fr-FR/projects/chawe/js/chat.js" type="text/javascript"></script>
	...
	<script src="https://glowe.fr/fr-FR/js/jquery.js"></script>
		<?php
			...
			if(in_array($p.'.func.js',$pages_js)){
				?>
					<script src="https://glowe.fr/fr-FR/projects/chawe/js/<?= $p ?>.func.js"></script>
				<?php
			}
